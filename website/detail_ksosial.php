...
<title>Pelayan Kegiatan Sosial</title>
...
<body>
  ...
  <div class="sidebar">
    ...
    <!-- Main Content -->
    <main class="content">
      <h1>Pelayan Kegiatan Sosial</h1>
      <div class="search-bar">
        <input type="text" placeholder="Cari Pelayan Profetik">
        <a href="sortir.php"><button class="sort-button">Sortir</button></a>
        <a href="buat_jadwal_sosial.php"><button class="add-button">Buat Jadwal +</button></a>
      </div>

      <!-- Tabel Data Jemaat -->
      <section class="table-section">
        <h2>Daftar Pelayan Kegiatan Sosial</h2>
        <table>
          <thead>
            <tr>
              <th>Nama Pelayan</th>
          ...
          <tbody id="data-jemaat">
            <tr>
              ...
              <td>0201</td>
              <td>Donasi</td>
              <td><a href="edit_pelayansos.php" onclick="editJemaat()">✏️</a> <a href="hapus.php" onclick="deleteJemaat()">🗑️</a></td>
            </tr>
